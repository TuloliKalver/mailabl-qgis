...
"}")
    ...
    def retranslateUi(self, Edenemine):
        ...
        self.label.setText(QCoreApplication.translate("Edenemine", u"Mine tee \u00fcks kohv ", None))
        self.label_2.setText(QCoreApplication.translate("Edenemine", u"J\u00f5uad m\u00f5ed k\u00fckid ka veel teha", None))
    # retranslateUi
