...
<qgis version="3.32.0-Lima" styleCategories="Symbology">
  <renderer-v2 forceraster="0" enableorderby="0" type="singleSymbol" symbollevels="0" referencescale="-1">
    <symbols>
      <symbol is_animated="0" type="fill" clip_to_extent="1" alpha="0.419" frame_rate="10" name="0" force_rhr="0">
        ...
        <layer class="GradientFill" locked="0" pass="0" id="{48c31fff-9d89-49c8-adbb-10b702a74c56}" enabled="1">
          <Option type="Map">
            ...
            <Option type="QString" value="204,204,204,255" name="gradient_color2"/>
        ...
        <layer class="SimpleFill" locked="0" pass="0" id="{5d4bbde9-c842-49a2-8aaf-b43eb0e86a68}" enabled="1">
          <Option type="Map">
            ...
            <Option type="QString" value="155,143,111,255" name="color"/>
