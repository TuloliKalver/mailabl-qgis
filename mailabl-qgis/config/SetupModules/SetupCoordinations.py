...
class CoordinationsSetup:
    def __init__(self, parent) -> None:
        self.dialog = parent

    def load_coordinations_settings_widget(self):

        module = Module.COORDINATION

        ui_file_path = Filepaths.get_conf_widget(FilesByNames.COORDINATIONS_UI)
        ...
        CoordinationsSetup.replace_frame(
            widget, 
            "FrameMain", 
        ...
        if result == QDialog.Accepted:
            ...
            types_names =cmbPreferredTypes.checkedItems()
            types_ids = []
            
            for index in range(cmbPreferredTypes.count()):
                if cmbPreferredTypes.itemCheckState(index) == Qt.Checked:
                    types_ids.append(cmbPreferredTypes.itemData(index))


            CoordinationsSetup.save_settings(self,
