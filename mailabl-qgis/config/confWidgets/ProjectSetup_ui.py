...
"}")
        ...
        self.f_Main.setMaximumSize(QtCore.QSize(730, 130))
        ...
        self.horizontalLayout_62.addWidget(self.lblProjectsFolder, 0, QtCore.Qt.AlignLeft)
        ...
        self.groupBox = QtWidgets.QGroupBox(LayeAdjuster)
        ...
        self.leSymbolCharacter = QtWidgets.QLineEdit(self.frame)
        self.leSymbolCharacter.setMinimumSize(QtCore.QSize(250, 0))
        ...
        self.verticalLayout_5.addWidget(self.leSymbolCharacter, 0, QtCore.Qt.AlignLeft)
        ...
        self.verticalLayout_6.addWidget(self.lblPreferedFolderNamStructure)
