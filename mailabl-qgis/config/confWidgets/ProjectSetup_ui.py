...
"}")
        ...
        self.frame = QtWidgets.QFrame(LayeAdjuster)
        ...
        self.verticalLayout_5.addWidget(self.leSymbolCharacter)
    ...
    def retranslateUi(self, LayeAdjuster):
        ...
        self.Confir_selecteded_element.setText(_translate("LayeAdjuster", "PushButton"))
