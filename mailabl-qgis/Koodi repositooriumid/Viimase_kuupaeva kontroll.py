"""
Selgitus antud koodile:

Koodi alguses imporditakse vajalikud QGIS moodulid ja PyQt5.QtCore moodul.
Määratakse kolme kihi nimed: "Test_põhi", "SHP_KATASTRIYKSUS_283" ja "Muudetavad kinnistud".
Hangitakse QGIS projekti kiht nimega "SHP_KATASTRIYKSUS_283" ja "Test_põhi".
Kontrollitakse, kas kihid on leitud. Kui kihti pole leitud, tõstetakse erind koos vastava veateatega.
Otsitakse kihi "Test_põhi" omadustest viimast kuupäeva väljalt "MUUDET".
Prinditakse viimane kuupäev soovitud formaadis.
Koostatakse filtritud objektide loend, mis vastavad tingimusele, et nende "MUUDET" välja väärtus on suurem või võrdne leitud viimase kuupäevaga.
Luuakse uus kiht, kasutades sisendi kihi koordinaatsüsteemi.
Lisatakse uue kihi väljad, mis vastavad sisendi kihi väljadele.
Lisatakse filtritud objektid uuele kihile.
Lisatakse uus kiht QGIS projekti.
Prinditakse filtritud objektide arv.
Valitakse uues kihis olevad objektid.
"""
